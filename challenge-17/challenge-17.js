...
var fullName = text.replace('Manuel Marques de Sousa', 'Cleyton de Sousa Costa')
...
var naturalidade = fullName.replace('brasileiro', 'Piauiense')
...
console.log(naturalidade.replace(/\d/g, '-'))
...
console.log(naturalidade.replace(/[H-Za-h]/g, '0'))
...
console.log(naturalidade.replace(/[A|a]/g, '4'))
...
console.log(naturalidade.replace(/O Centauro de Luvas/g, function(phrase) {
...
console.log(naturalidade.replace(regexDate, replaceDate));
